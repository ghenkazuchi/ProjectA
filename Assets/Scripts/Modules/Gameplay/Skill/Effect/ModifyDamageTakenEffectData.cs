...
public class ModifyDamageTakenEffectData : EffectData
{
	...
	public override EffectBase CreateRuntimeEffect(EntityBase owner, EntityBase target, int duration) => new ModiftyDamageTaken(this, owner, target, duration, IncreasePercentage);
}
